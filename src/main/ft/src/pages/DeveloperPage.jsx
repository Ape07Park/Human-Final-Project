...
const DeveloperPage = () => {
  ...
  return (
    <div style={appStyle}>
      <img src={'/ft/img/topimage.png'} alt="Main" style={{ width: '50%', height: 'auto', objectFit: 'cover', margin: '20px auto' }} /> 
